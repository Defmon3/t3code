...
export function makePreviewAutomationKeySequence(
  ...
  return {
    keyDown: { type: "rawKeyDown", keyCode: definition.nativeKeyCode, modifiers },
    ...(!suppressText && definition.text
      ? { char: { type: "char" as const, keyCode: definition.text, modifiers } }
      : {}),
    keyUp: { type: "keyUp", keyCode: definition.nativeKeyCode, modifiers },
