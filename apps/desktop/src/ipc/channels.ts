...
export const PREVIEW_AUTOMATION_OBSERVE_START_CHANNEL = "desktop:preview-automation-observe-start";
export const PREVIEW_AUTOMATION_OBSERVE_READ_CHANNEL = "desktop:preview-automation-observe-read";
export const PREVIEW_AUTOMATION_OBSERVE_STOP_CHANNEL = "desktop:preview-automation-observe-stop";
