...
import { generateComposerAutocomplete } from "./composerAutocomplete.ts";
  ...
  WsRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      return WsRpcGroup.of({
        [WS_METHODS.serverComposerAutocomplete]: (input) =>
          observeRpcEffect(
            WS_METHODS.serverComposerAutocomplete,
            generateComposerAutocomplete(input),
          ),
