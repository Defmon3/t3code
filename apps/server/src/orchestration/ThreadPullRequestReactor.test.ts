...
describe("isThreadPullRequestCurrent", () => {
  it("rejects only terminal pull requests completed before the thread", () => {
    const threadCreatedAt = "2026-09-01T12:00:00.000Z";
    expect(
      ThreadPullRequestReactor.isThreadPullRequestCurrent(threadCreatedAt, {
        state: "merged",
        completedAt: "2026-09-01T11:59:59.999Z",
      }),
    ).toBe(false);
    expect(
      ThreadPullRequestReactor.isThreadPullRequestCurrent(threadCreatedAt, {
