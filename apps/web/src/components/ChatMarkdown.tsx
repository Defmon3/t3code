...
interface ChatMarkdownProps {
  ...
  extraRemarkPlugins?: NonNullable<ReactMarkdownOptions["remarkPlugins"]> | undefined;
}
...
const MarkdownFileLink = memo(function MarkdownFileLink({
  ...
  const useBrowserPrimaryAction =
    (canOpenInBrowser && isBrowserPreviewFile(iconPath)) ||
