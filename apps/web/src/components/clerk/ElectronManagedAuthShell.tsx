import { passkeys as clerkElectronPasskeys } from "@clerk/electron/passkeys";
...
export const electronPasskeys: typeof clerkElectronPasskeys = {
  ...clerkElectronPasskeys,
