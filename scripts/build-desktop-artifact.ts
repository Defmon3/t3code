...
export class ResourceMonitorProtocolVersionMismatchError extends Schema.TaggedError<ResourceMonitorProtocolVersionMismatchError>()(
...
export class ResourceMonitorProtocolVersionSourceInvalidError extends Schema.TaggedError<ResourceMonitorProtocolVersionSourceInvalidError>()(
